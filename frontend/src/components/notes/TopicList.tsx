      ...
      <NotepadBanner>
        <div className="px-3 py-2">
          <button
            ...
            className={`w-full rounded px-1.5 py-1 text-left font-hand text-lg transition ${
              ...
              {topic.subtopics.map((sub) => (
                <li key={sub.id}>
                  <button
                    ...
                    className={`w-full rounded px-1.5 py-1 text-left font-hand text-base transition ${
