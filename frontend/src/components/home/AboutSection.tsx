export default function AboutSection() {
  return (
    <section id="about" className="bg-paper px-6 py-24 sm:px-14">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h2 className="mb-8 font-serif text-3xl text-mercury-ink sm:text-4xl">
          Named for Mercury — the planet of knowledge, wisdom, and communication.
        </h2>
        <p className="mx-auto max-w-2xl text-lg leading-relaxed text-ink-soft">
          ...
          place, so studying never turns into a last-minute scramble across ten different apps and
