...
export default function ChalkboardMenu({
  ...
  return (
    <div
      className="relative flex min-h-[calc(100svh-76px)] flex-col items-center justify-center overflow-hidden px-3 py-10 sm:min-h-[calc(100vh-64px)] sm:px-10 sm:py-16"
      style={{
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-0 w-full max-w-2xl overflow-hidden rounded-md border-[10px] border-[#6B4A35] p-5 sm:border-[14px] sm:p-12"
        style={{
          background: "#242b21",
      ...
      >
        ...
        <div className="relative mb-3 flex items-center justify-center gap-3">
          ...
          <h2
            className="text-center font-sans text-3xl font-extrabold uppercase tracking-wide text-white sm:text-5xl"
          ...
          {subjects.map((subject, i) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className="font-chalk text-xl sm:text-3xl"
                  style={{
                    color,
